...
const tools = [
    ...
    { id: 'priv-9', name: 'uBlock Origin', url: 'https://api.iconify.design/logos:u-block-origin.svg' }, // Check name
    ...
    { id: 'stream-19', name: 'Tenacity', url: 'https://api.iconify.design/simple-icons:tenacity.svg' }, // Might fail
    ...
    { id: 'read-1', name: 'Project Gutenberg', url: 'https://api.iconify.design/simple-icons:gutenberg.svg' }, // Might be different
    ...
    // { id: 'dl-3', name: 'IDM', url: '' }, // Likely missing
    ...
    { id: 'ai-9', name: 'Copy.ai', url: 'https://api.iconify.design/logos:copy-ai.svg' }, // Check
...
(async () => {
    ...
    valid.forEach(v => console.log(`${v.id}: ${v.url}`));

    console.log('\n--- Invalid URLs ---');
    invalid.forEach(v => console.log(`${v.id} (${v.name}): ${v.url} (${v.status})`));
})();
